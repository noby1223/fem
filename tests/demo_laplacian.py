...
if Dirichlet_with_multipliers:
    ...
    md.add_Dirichlet_condition_with_penalization(
        mim, "u", dirichlet_coefficient, DIRICHLET_BOUNDARY_NUM1, "DirichletData"
    )
...
if Dirichlet_with_multipliers:
    ...
    md.add_Dirichlet_condition_with_penalization(
        mim, "u", dirichlet_coefficient, DIRICHLET_BOUNDARY_NUM2, "DirichletData"
    )
gf.memstats()
# md.listvar()
# md.listbricks()
...
# Export data
mfu.export_to_vtk("laplacian.vtk", Ue, "Exact solution", U, "Computed solution")
print("You can view the solution with (for example):")
print("gmsh laplacian.vtk")
