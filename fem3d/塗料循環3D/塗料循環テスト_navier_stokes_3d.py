...
m = gf.Mesh("import", "gmsh", "/home/noby/fem/fem3d/塗料循環3D/msh/塗料循環3d")
...
#MeshFem
mfv_ = gf.MeshFem(m, 3)#2は次元数 ここを１から２にするとmfv_.nb_basic_dof()が２倍になる(要はスカラーからベクトルになる)
...
#mmatはΔtの間変わらない、vvだけ変化させている
   ...
   mfv.export_to_vtk("/home/noby/fem/fem3d/塗料循環3D/vtk/results_%i.vtk" % step,
