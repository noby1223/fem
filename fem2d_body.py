...
md.add_initialized_data('eps', [epsilon])#初期化された固定サイズデータをモデルに追加します
md.add_linear_term(mim, sigmaeps+'*(Grad_V.Grad_Test_V)')#アセンブリ文字列 expr で指定された非線形項を追加します．この意味はsigamaeps*grad_V.Test_Grad_Vってことだな 
